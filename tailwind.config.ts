  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%, 100%': {
            boxShadow: '0 0 20px rgba(30, 95, 191, 0.35), 0 0 40px rgba(138, 43, 226, 0.25), 0 0 60px rgba(255, 105, 180, 0.15)',
          },
          '50%': {
            boxShadow: '0 0 30px rgba(30, 95, 191, 0.55), 0 0 60px rgba(138, 43, 226, 0.35), 0 0 90px rgba(255, 105, 180, 0.2)',
          },
        },
        shimmer: {
